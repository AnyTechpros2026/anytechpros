            ...
            {[
              {
                ...
                description: 'Comprehensive GTM plans that accelerate revenue and reduce time-to-market.'
              },
              {
                number: '02',
                title: 'Sales Transformation',
                description: 'Build efficient, scalable sales organizations that drive predictable revenue.'
              },
              {
                number: '03',
                title: 'Revenue Optimization',
                description: 'Implement systems and processes that maximize revenue potential.'
              },
            ].map((item, index) => (
        ...
        <div className="container-custom max-w-3xl mx-auto text-center">
          <ScrollAnimation>
            ...
            <p className="text-base md:text-lg text-text-muted dark:text-text-dark-muted mb-8">
              We're looking for consultants and strategists with passion for driving business growth. Help us transform companies through sales excellence.
            </p>
            <Link to="/careers">
