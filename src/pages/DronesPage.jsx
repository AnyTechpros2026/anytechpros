...
const DronesPage = () => {
  ...
  const applications = [
    ...
    { icon: 'industry', title: 'Industrial Inspection', description: 'Safe and efficient inspection of industrial facilities, towers, and power lines.', bgColor: 'bg-[#A8B5A1]', textColor: 'text-[#2F3B35]' }
  ];
  ...
  return (
    <div className="pt-20 md:pt-24">
      ...
      <section className="relative min-h-[500px] md:min-h-[600px] bg-cover bg-center flex items-center justify-center overflow-hidden"
        style={{ backgroundImage: `linear-gradient(rgba(31, 31, 31, 0.7) 0%, rgba(31, 31, 31, 0.8) 100%), url('https://images.unsplash.com/photo-1508843671828-3a1de2c2f4e1?q=80&w=2000&auto=format&fit=crop')` }}>
        ...
        <div className="container-custom px-4 md:px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={index} className="scroll-animate bg-taupe/20 dark:bg-charcoal-light p-8 text-center">
        ...
        <div className="container-custom px-4 md:px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {applications.map((app, index) => (
              <div key={index} className={`scroll-animate ${app.bgColor} ${app.textColor} p-6 hover:opacity-90 transition-opacity duration-300`}>
        ...
        <div className="container-custom px-4 md:px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {specifications.map((spec, index) => (
              <div key={index} className="scroll-animate bg-white dark:bg-charcoal p-6">
